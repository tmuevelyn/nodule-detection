...
luna_subset_path = '/home/evelynlin/Lung-nodule-detection-LUNA-16/dataset/subset3/'
result_path = '/home/evelynlin/Lung-nodule-detection-LUNA-16/img_results/'
img_file = '/home/evelynlin/Lung-nodule-detection-LUNA-16/dataset/subset3/1.3.6.1.4.1.14519.5.2.1.6279.6001.244681063194071446501270815660.mhd'
itk_img = sitk.ReadImage(img_file) 
img_tensor = torch.from_numpy(sitk.GetArrayFromImage(itk_img)).unsqueeze(1).float()


seg_model_loadPath = '/home/evelynlin/Lung-nodule-detection-LUNA-16/Results/SUMNet/Adam_1e-4_ep100/'
